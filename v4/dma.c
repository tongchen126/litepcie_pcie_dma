...
#define LITEPCIE_DMA_BUF_ORDER (11)
...
static void irq0_work_func(struct work_struct *work)
{
	...
	litepcie_writel(s,CSR_PCIE_HOST_PCIE2WB_DMA_LENGTH_ADDR,4*1024*1024);
	...
	litepcie_writel(s,CSR_PCIE_HOST_PCIE2WB_DMA_HOST_ADDR_ADDR,s->dma_addr+4*1024*1024);
	litepcie_writel(s,CSR_PCIE_HOST_PCIE2WB_DMA_LENGTH_ADDR,4*1024*1024);
	litepcie_writel(s,CSR_PCIE_HOST_PCIE2WB_DMA_BUS_ADDR_ADDR,MAIN_RAM_BASE+4*1024*1024);
	litepcie_writel(s,CSR_PCIE_HOST_PCIE2WB_DMA_RD_ENABLE_ADDR,1);
...
static void irq1_work_func(struct work_struct *work)
{
	...
	litepcie_writel(s,CSR_PCIE_HOST_WB2PCIE_DMA_SC_DEPTH_ADDR,2);
	

	litepcie_writel(s,CSR_PCIE_HOST_WB2PCIE_DMA_HOST_ADDR_ADDR,s->dma_addr);
	litepcie_writel(s,CSR_PCIE_HOST_WB2PCIE_DMA_LENGTH_ADDR,4*1024*1024);
	litepcie_writel(s,CSR_PCIE_HOST_WB2PCIE_DMA_BUS_ADDR_ADDR,MAIN_RAM_BASE+0x800000);
...
//	litepcie_writel(s,CSR_PCIE_HOST_WB2PCIE_DMA_LENGTH_ADDR,4*1024);
	...
	litepcie_writel(s,CSR_PCIE_HOST_WB2PCIE_DMA_HOST_ADDR_ADDR,s->dma_addr+4*1024*1024);
	litepcie_writel(s,CSR_PCIE_HOST_WB2PCIE_DMA_LENGTH_ADDR,4*1024*1024);
	litepcie_writel(s,CSR_PCIE_HOST_WB2PCIE_DMA_BUS_ADDR_ADDR,MAIN_RAM_BASE+0x800000+4*1024*1024);
	litepcie_writel(s,CSR_PCIE_HOST_WB2PCIE_DMA_WR_ENABLE_ADDR,1);
